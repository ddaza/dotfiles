...
hi clear
syntax reset
let g:colors_name = "PaperColorMine"
...
if s:is_dark " DARK VARIANT
  ...
  let s:search_bg = ['#f8fe00', '100']

  " Visual:
  "let s:visual_fg = ['#000000', '16']
  let s:visual_fg = ['#8787af', '300']
  "let s:visual_bg = ['#8787af', '103']
  let s:visual_bg = ['#7872af', '103']
  ...
  if exists("g:PaperColorMine_Dark_Override")
    call s:Load_Settings_Override(g:PaperColorMine_Dark_Override)
  endif
  ...
  " User Override Settings:
  if exists("g:PaperColorMine_Light_Override")
    call s:Load_Settings_Override(g:PaperColorMine_Light_Override)
  endif
endif
" }}}
